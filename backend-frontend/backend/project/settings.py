...
STATIC_ROOT = os.path.join(BASE_DIR, 'static-files') if not RUNNING_ONLINE else '/static-files/'

MEDIA_URL = 'media-files/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media-files') if DEBUG else '/media-files/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media-files') if not RUNNING_ONLINE else '/media-files/'

# APP_CLIPS_URL = '.well-known/'
# APP_CLIPS_ROOT = os.path.join(BASE_DIR, 'well-known') if not RUNNING_ONLINE else '/well-known/'
