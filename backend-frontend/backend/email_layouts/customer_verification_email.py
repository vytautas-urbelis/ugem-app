...
#                     Thank you for joining uGem! Please press on "Verify" below to finish your email verification:
#                 </p>
#                 <p style="color: #555; font-size: 16px;">
#                     <a href="{front_end_root}/verify-email/{code}" style="color: #333; text-decoration: none; font-weight: bold;">VERIFY</a>
#                 </p>
#             </td>
#         </tr>
...
def customer_verification_link(front_end_root, code):
    return f'''<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <table role="presentation">
        ...
        <tr class="content">
            <td>
                ...
                <a href="{front_end_root}/verify-email/{code}" class="button">Verify Your Email</a>
            </td>
        </tr>
        <tr class="footer">
            <td>
