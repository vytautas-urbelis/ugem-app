...
def business_email_layout(qr_code, media_root):
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
        <tr style="background-color: #f2edae;">
            <td style="padding: 20px; text-align: center;">
                ...
                <h1 style="color: #333; font-size: 24px; margin-top: 20px;">uGem Business QR code</h1>
            </td>
        </tr>
        <tr>
            <td style="padding: 20px; text-align: center; background-color: #fff;">
                <p style="color: #555; font-size: 16px; margin-bottom: 20px;">
                    Below you can find your business QR code.
                </p>
