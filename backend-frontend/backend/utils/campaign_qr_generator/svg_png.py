...
def generate_campaign_qr(text):
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="1120" height="1240" viewBox="0 0 1120 1240">
        <!-- Add a rounded border -->
        <g transform="translate(19, 19)">  <!-- Adjust positioning and scale -->
        <rect x="1.5" y="1.5" width="1080" height="1200" rx="30" ry="30" fill="none" stroke="black" stroke-width="40"/>
        </g>
        ...
        <g transform="translate(460, 1100) scale(1)">  <!-- Adjust positioning and scale -->
            {overlay_content}
        </g>
    </svg>
    """
