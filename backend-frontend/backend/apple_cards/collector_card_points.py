...
def create_collector_card_points(nickname, serial_nr, to_qr, campaign_name, business_name, value_counted, collector_id,
                                 secret_key, customer_id, collector_type, value_goal):
    cardInfo = StoreCard()
    cardInfo.addPrimaryField('Campaign', f'{value_counted} {collector_type}', f'CAMPAIGN GOAL: {value_goal} {collector_type}')
