...
export default function ConfLogOut({setIsLogOut}) {
    ...
    const logOut = () => {
        ...
        logOutAll(Purchases, setIsLogOut, setIsLoading, setIsLoading)
                    ...
                    <View className="flex w-full items-center justify-center flex-row">
                        ...
                        >
                            <View style={styles.shadow}>
                                <Text className="w-full text-base text-center">Log out</Text>
                            </View>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() => {
                                setIsLogOut(false); // Close logout modal on cancel
                            }}>
                            <View style={styles.shadow}>
